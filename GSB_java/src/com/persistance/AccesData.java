...
public class AccesData {
    ...
    /**
     * Accesseur getVisiteur qui prend en parram�tre un id Visiteur et nous
    ...
    /**
     * Modificateur createVisiteur qui prend un parram�tre Visiteur et qui ira
    ...
    /**
     * Modificateur updateVisiteur qui prend un parram�tre Visiteur et qui ira
    ...
    /**
     * Modificateur deleteVisiteur qui prend un parram�tre Visiteur et qui ira
 ...
 /*   public static List<Visiteur> getUtilistaeyrRegion(Region r){
    ...
    /**
     * Retourne une liste de region dont le nombre d'utilisateurs est superieur à zero 
     * pour éviter la division par 0 dans les stats
     * 
     * @return la liste des regions concernées
     */
